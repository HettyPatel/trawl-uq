"""
MCQ Entropy-Based SVD Truncation Experiment (LASER-style)
...
3. For each reduction %: truncate SVD, measure MCQ entropy/accuracy, restore
4. Find optimal reduction level (best accuracy with maximum compression)
...
def run_mcq_entropy_svd_truncation(
    ...
    """
    Run MCQ entropy-based SVD truncation experiment.
    ...
    print("=" * 70)
    print("MCQ ENTROPY SVD TRUNCATION EXPERIMENT")
    print("=" * 70)
    ...
    if best_results:
        ...
        print(f"  Keeps {most_compressed['components_kept']} components")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="MCQ entropy-based SVD truncation experiment")
