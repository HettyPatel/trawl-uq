#!/bin/bash
# Run SVD noise removal with mlp_in + mlp_out on layers 10-15 (MCQ ARC Challenge)
# Usage: bash scripts/run_noise_removal_layers10_15.sh
...
for LAYER in 10 11 12 13 14 15; do
    echo "=========================================="
